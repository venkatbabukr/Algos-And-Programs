 ...
 * 
 * Source: https://github.com/callicoder/java-snowflake
 * 
 * @author vbkomarl
 */
public class SnowflakeIDGenerator {
    ...
    public static void main(String[] args) {
        SnowflakeIDGenerator gen1 = new SnowflakeIDGenerator();
        long nextId = gen1.nextId();
        System.out.format("Gen1=%s, NextId=%d, Parsed=%s%n", gen1,
                              nextId, Arrays.toString(gen1.parse(nextId)));
    }
