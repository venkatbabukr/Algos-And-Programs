...
public class CandyDistributionSolver {
    ...
    public CandyDistributionSolver(int[] ranksArr) {
        if (ArraysExt.isEmpty(ranksArr))
            throw new IllegalArgumentException("Atleast one rank element should be given!");
        this.ranks = ranksArr;
    }

    /**
     * O(n) solution. Ref: https://medium.com/javarevisited/how-to-solve-the-minimum-candy-distribution-problem-4c868740f16a
     * 
     * @return
     */
    public int findMinTotalRequired() {
        int[] candiesArr = new int[ranks.length];
