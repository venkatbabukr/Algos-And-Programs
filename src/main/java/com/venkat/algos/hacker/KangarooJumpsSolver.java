...
public class KangarooJumpsSolver {
    ...
    class IntersectionPoint {
        ...
        public boolean intersectPossible() {
            return j > 0.0 && j - Math.floor(j) == 0.0;
            // We can also use j % 1!
            // return j > 0.0 && j % 1 == 0;
        }
    ...
    public IntersectionPoint findIntersectionPoint(int x1, int v1, int x2, int v2) {
        double j = 0;
        if (v1 == v2) {
            j = x1 == x2 ? x1 : -1;
        } else {
    ...
    public static void main(String[] args) {
        ...
        int x1, v1, x2, v2;
        x1 = 0; v1 = 3; x2 = 4; v2 = 2;
        System.out.format("Intersection point for x1=%d, v1=%d, x2=%d, v2=%d: %s%n", x1, v1, x2, v2, solver.findIntersectionPoint(x1, v1, x2, v2));
        x1 = 0; v1 = 2; x2 = 5; v2 = 3;
        System.out.format("Intersection point for x1=%d, v1=%d, x2=%d, v2=%d: %s%n", x1, v1, x2, v2, solver.findIntersectionPoint(x1, v1, x2, v2));
        x1 = 3; v1 = 3; x2 = 2; v2 = 6;
        System.out.format("Intersection point for x1=%d, v1=%d, x2=%d, v2=%d: %s%n", x1, v1, x2, v2, solver.findIntersectionPoint(x1, v1, x2, v2));
